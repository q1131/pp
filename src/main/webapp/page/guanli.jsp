...
<DIV id=header class=wrap>
  ...
  <DIV class=search> 【欢迎:${user.name}】   <LABEL class="ui-green searchs"><a href="/house/gofabu" title="">发布房屋信息</a></LABEL> <LABEL class="ui-green searchs"><a href="/house/getUserHouse" title="">管理房屋信息</a></LABEL>
    ...
    <TABLE class=house-list>
      ...
      <A href="details.jsp" target="_blank">
        <img src="http://localhost:80/${h.path}" width="100" height="75" alt=""></A></SPAN></TD>
          ...
          <TD class=house-type><LABEL class=ui-green><INPUT onclick="location.href='/house/getHouse?id=${h.id}';" value="修    改" type=button name=search></LABEL></TD>
          <TD class=house-price><LABEL class=ui-green><INPUT onclick="location.href='/house/delHouse?id=${h.id}';" value="删    除" type=button name=search>
          </LABEL></TD>
        </TR>
      </c:forEach>
      </TBODY></TABLE></DIV>
